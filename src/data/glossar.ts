...
export const glossar: GlossarEintrag[] = [
  {
    ...
    siehe: [
      { label: 'EDMO', href: '/atlas/edmo' },
      { label: 'Amadeu Antonio Stiftung', href: '/atlas/amadeu-antonio-stiftung' },
    ],
  },
  {
    term: 'NetzDG',
    ...
    siehe: [{ label: 'Amadeu Antonio Stiftung', href: '/atlas/amadeu-antonio-stiftung' }],
  },
  {
    term: 'IFCN',
    ...
    siehe: [
      { label: 'Correctiv', href: '/atlas/correctiv' },
      { label: 'dpa-Faktencheck', href: '/atlas/dpa-faktencheck' },
    ],
  },
  {
    term: 'EDMO',
    ...
    siehe: [{ label: 'EDMO-Profil', href: '/atlas/edmo' }],
  },
  {
    term: 'SMC',
    ...
    siehe: [{ label: 'SMC-Profil', href: '/atlas/science-media-center-germany' }],
  },
  {
    term: 'Five Eyes',
    definition:
    ...
    siehe: [{ label: 'ISD', href: '/atlas/institute-for-strategic-dialogue' }],
  },
  {
    term: 'USAID',
    ...
    siehe: [{ label: 'Internews', href: '/atlas/internews-earth-journalism-network' }],
  },
  {
    term: 'DCMS',
